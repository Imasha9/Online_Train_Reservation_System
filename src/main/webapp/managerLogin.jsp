...
<head>
    ...
    <style>
        /* Internal CSS */
        body {
            background-image: url('https://i0.wp.com/travelobservations.com/wp-content/uploads/2020/09/jack-anstey-XVoyX7l9ocY-unsplash-1-scaled.jpg?resize=1800%2C1200&ssl=1'); /* URL to your background image */
